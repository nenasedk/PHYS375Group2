...
figure(3)
hold on
scatter(logscMass, logRad, 'DisplayName', 'Calculated Radii')
plot(logscMass, logempiricrad, 'DisplayName', 'Empiric Relation')
xlabel('M (solar units)')
